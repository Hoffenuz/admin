            ...
            <div className="mb-8">
              ...
              <div className="card p-6 mt-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-secondary-700 mb-2">To'lov summasi (so'm)</label>
                    <input 
                      type="number"
                      placeholder="0"
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                  ...
                  <div className="relative bg-white rounded-lg shadow-xl w-full max-w-sm mx-4">
                    ...
                    <div className="px-5 py-4 space-y-3">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-secondary-700 mb-2">To'lov summasi</label>
                        <input
                          placeholder="0"
